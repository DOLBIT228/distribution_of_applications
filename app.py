    ...
    steps = [
        {
            ...
            "description": (
                "Цей інструмент створений для спрощення роботи менеджерів з дзвінків. Він повністью заберає логіку ділення заявок між менеджерів на себе в напрямку - Сайт"
            ),
        ...
        },
        {
            ...
            "description": (
                "Для початку розподілу заявок необхідно обрати менеджерів які будуть працюють на змінні."
            ),
        ...
        },
        {
            ...
            "description": (
                "Наступним кроком потрібна натиснути кнопку розпочати "
            ),
